...
#  for fusion in 'score' 'fc';
  ...
  for weights in '0' '0.05' '0.1' '0.15' '0.2' '0.25' '0.3' '0.35' '0.40' '0.45' '0.5' '0.55' '0.6' '0.65' '0.7' '0.75' '0.8' '0.85' '0.90' '0.95';
  do
    python test.py --fusion='fc' --dataset=$DATASET --reid="BtoB" --trained="BtoB" --fuse='none' --LOO=$LOO --weight=$weights ;
  done
